...
TOOL_SCHEMAS = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                "Сравнить одну метрику в двух периодах: вернуть значения A и B, "
                "разницу (delta) и отношение (ratio = B/A). Используй для вопросов "
                "«на сколько вырос», «во сколько раз», «как изменился» между датами. "
                "Метрики: key_rate, fx_USD, fx_EUR, fx_CNY, cpi, unemployment. "
                "Периоды: YYYY-MM или YYYY-MM-DD."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "metric": {
                        ...
                        "description": "Какую метрику сравниваем",
                    },
                    "period_a": {
                        "type": "string",
                        "description": "Начальный период, например 2022-01",
                    },
                    "period_b": {
                        "type": "string",
                        "description": "Конечный период, например 2026-04",
                    },
                },
